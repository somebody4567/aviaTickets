...
/* harmony import */ var _store_locations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./store/locations */ "./src/js/store/locations.js");
/* harmony import */ var _plugins__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins */ "./src/js/plugins/index.js");
/* harmony import */ var _views_formUI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/formUI */ "./src/js/views/formUI.js");
/* harmony import */ var _views_tickets__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/tickets */ "./src/js/views/tickets.js");
/* harmony import */ var _services_apiService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/apiService */ "./src/js/services/apiService.js");
/* harmony import */ var _views_localStorage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/localStorage */ "./src/js/views/localStorage.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function initApp() {
    await _store_locations__WEBPACK_IMPORTED_MODULE_0__["default"].init();
    _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].updateData();
    _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].setHandlerOnInputs();
    _views_tickets__WEBPACK_IMPORTED_MODULE_3__["default"].init();
    _views_localStorage__WEBPACK_IMPORTED_MODULE_5__["default"].init();
  }

  _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].form.addEventListener('submit', e => {
    e.preventDefault();
    const message = document.createElement('div');

    if (Array.from(_views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].inputsElements).some(item => item.value == '')) {
      message.classList.add('message');
      message.textContent = 'Пожалуйста, заполните все поля.';
      _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].cardActionElement.append(message);
    } else {
      try {
        message.remove();
      } catch (err) {}
  ...
  async function onFormSubmit() {
    const currency = _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].currencyValue;
    const origin = _store_locations__WEBPACK_IMPORTED_MODULE_0__["default"].getCityCodeByKey(_views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].originValue);
    const destination = _store_locations__WEBPACK_IMPORTED_MODULE_0__["default"].getCityCodeByKey(_views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].destinationValue);
    const depart_date = _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].departValue;
    const return_date = _views_formUI__WEBPACK_IMPORTED_MODULE_2__["default"].returnValue;
    const response = await _store_locations__WEBPACK_IMPORTED_MODULE_0__["default"].fetchTickets({
      origin,
      destination,
      depart_date,
      return_date,
    ...
    _views_tickets__WEBPACK_IMPORTED_MODULE_3__["default"].createTickets(response);
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _materialize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./materialize */ "./src/js/plugins/materialize.js");
...
/*!***************************************!*\
  !*** ./src/js/plugins/materialize.js ***!
  \***************************************/
/*! exports provided: getAutocompleteInstance, getDatePickerInstance */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAutocompleteInstance", function() { return getAutocompleteInstance; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDatePickerInstance", function() { return getDatePickerInstance; });
/* harmony import */ var materialize_css_dist_js_materialize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! materialize-css/dist/js/materialize */ "./node_modules/materialize-css/dist/js/materialize.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _config_apiConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/apiConfig */ "./src/js/config/apiConfig.js");
...
const api = new Api(_config_apiConfig__WEBPACK_IMPORTED_MODULE_0__["default"]);
/* harmony default export */ __webpack_exports__["default"] = (api);

/***/ }),

/***/ "./src/js/store/locations.js":
/*!***********************************!*\
  !*** ./src/js/store/locations.js ***!
  \***********************************/
/*! exports provided: default */
...
/* harmony import */ var _services_apiService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/apiService */ "./src/js/services/apiService.js");
...
const locations = new Locations(_services_apiService__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ __webpack_exports__["default"] = (locations);

/***/ }),

/***/ "./src/js/views/formUI.js":
/*!********************************!*\
  !*** ./src/js/views/formUI.js ***!
  \********************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _store_locations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../store/locations */ "./src/js/store/locations.js");
/* harmony import */ var _plugins_materialize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../plugins/materialize */ "./src/js/plugins/materialize.js");
...
class FormUI {
  constructor() {
    ...
    this.inputs = document.querySelectorAll('[data-input]'); //Создаем экземпляры input'ов для того чтобы с ними поработать

    this.originInstanse = Object(_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__["getAutocompleteInstance"])(this.origin);
    this.destinationInstanse = Object(_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__["getAutocompleteInstance"])(this.destination);
    this.departInstanse = Object(_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__["getDatePickerInstance"])(this.depart);
    this.returnInstanse = Object(_plugins_materialize__WEBPACK_IMPORTED_MODULE_1__["getDatePickerInstance"])(this.return);
  }
  ...
  updateData() {
    this.originInstanse.updateData(_store_locations__WEBPACK_IMPORTED_MODULE_0__["default"].shortCitiesList);
    this.destinationInstanse.updateData(_store_locations__WEBPACK_IMPORTED_MODULE_0__["default"].shortCitiesList);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tickets__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tickets */ "./src/js/views/tickets.js");
...
class LocalStorage {
  ...
  init() {
    if (!localStorage.getItem('favourites')) {
      ...
      JSON.parse(localStorage.getItem('favourites')).forEach(obj => _tickets__WEBPACK_IMPORTED_MODULE_0__["default"].createTicket(obj));
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (localSt);

/***/ }),

/***/ "./src/js/views/tickets.js":
/*!*********************************!*\
  !*** ./src/js/views/tickets.js ***!
  \*********************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store_locations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/locations */ "./src/js/store/locations.js");
  ...
  async createTickets(data) {
    ...
    if (dataLength > 0) {
      ...
      Object.entries(data.data).forEach(([key, value], i) => {
        ...
        const month = time.toLocaleString('en', {
          month: 'short'
        }).slice(0, 3);
        ...
        ticket.innerHTML = `
                <div class="card ticket-card">
                    ...
                    <span class="ticket-airline-name">${_store_locations__WEBPACK_IMPORTED_MODULE_1__["default"].airlines[value.airline] || ''}</span>
                    </div>
                    <div class="ticket-destination d-flex align-items-center">
                    <div class="d-flex align-items-center mr-auto">
                        <span class="ticket-city">${_store_locations__WEBPACK_IMPORTED_MODULE_1__["default"].getCityNameByCode(value.origin)}</span>
                        <i class="medium material-icons">flight_takeoff</i>
                    </div>
                    <div class="d-flex align-items-center">
                        <i class="medium material-icons">flight_land</i>
                        <span class="ticket-city">${_store_locations__WEBPACK_IMPORTED_MODULE_1__["default"].getCityNameByCode(value.destination)}</span>
                    </div>
                    </div>
      ...
      this.parent.insertAdjacentHTML('beforeend', `<div class="tickets-empty-res-msg">
  ...
  addTicket() {
    this.add.forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        const objData = this.getTicketData(btn); // Добавляем объект билета в LS
